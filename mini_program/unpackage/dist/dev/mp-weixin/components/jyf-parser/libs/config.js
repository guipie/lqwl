...
const cfg = {
  ...
  // 信任的标签
  trustTags: makeMap(
    "a,abbr,ad,audio,b,blockquote,br,code,col,colgroup,dd,del,dl,dt,div,em,fieldset,h1,h2,h3,h4,h5,h6,hr,i,img,ins,label,legend,li,ol,p,q,source,span,strong,sub,sup,table,tbody,td,tfoot,th,thead,tr,title,ul,video,embed,iframe"
  ),
  // 默认的标签样式
  userAgentStyles: {
...
exports.cfg = cfg;
//# sourceMappingURL=../../../../.sourcemap/mp-weixin/components/jyf-parser/libs/config.js.map
